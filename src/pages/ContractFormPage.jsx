    ...
    try {
      ...
      if (isEditMode && contractData.firebaseKey) {
        ...
        const updateData = {
          ...
          soKhung: safeValue(normalizedContract.soKhung),
          soMay: safeValue(normalizedContract.soMay),
          namSanXuat: safeValue(normalizedContract.namSanXuat),
        ...
        if (oldStatusLower !== "xuất" && newStatusLower === "xuất") {
          ...
          const exportedData = {
            ...
            "Tiền đối ứng": parseCurrency(calculatedTienDoiUng),
            tienDoiUng: parseCurrency(calculatedTienDoiUng),
            "Số Khung": safeValue(normalizedContract.soKhung),
            "Số Máy": safeValue(normalizedContract.soMay),
            namSanXuat: safeValue(normalizedContract.namSanXuat),
            "Năm sản xuất": safeValue(normalizedContract.namSanXuat),
            year: safeValue(normalizedContract.namSanXuat),
